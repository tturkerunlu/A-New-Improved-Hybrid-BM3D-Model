...
def z8(img_path: str, ckpt_path: str, input_is_noisy: bool, sigma_255: float, seed: int, profile: str, colorspace: str, tile_rows: int, use_softblend: bool, out_root: str, device: str, demo_mode: bool=False):
    z20 = z7(img_path)
    if z20 is None:
